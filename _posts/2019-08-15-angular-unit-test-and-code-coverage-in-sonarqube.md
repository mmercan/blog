...
<!-- wp:paragraph -->
<p>you should also see <strong>coverage </strong>folder in your project's root folder.<br>as the test is running fine we can start the last step getting them into SonarQube<br>first Create <strong>sonar-project.properties</strong> file in the root folder of your angular project, <br>I used SonarCloud and installed instance of SonarQube this file works fine with both (if you are running your SonarQube Instance, you don't need sonar.organization)</p>
<!-- /wp:paragraph -->
